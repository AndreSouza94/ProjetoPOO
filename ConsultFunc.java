...
public class ConsultFunc extends javax.swing.JFrame {
   ...
   public void buscar() {
    try {
        ...
        if (rbAtendente.isSelected()) {
            Atendente atd = BDPizz.getBDPizz().consultaATD(nome);
            if (atd != null) {
                atd.exibirDados();
                encontrado = true;
            }
        ...
        if (rbEntregador.isSelected()) {
            Entregador entreg = BDPizz.getBDPizz().consultaEntreg(nome);
            if (entreg != null) {
                entreg.exibirDados();
                encontrado = true;
            }
        ...
        if (rbCozinheiro.isSelected()) {
            Cozinheiro coz = BDPizz.getBDPizz().consultaCozinheiro(nome);
            if (coz != null) {
                coz.exibirDados();
                encontrado = true;
            }
    ...
    try {
        ...
        if (rbAtendente.isSelected()) {
            Atendente atd = BDPizz.getBDPizz().consultaATD(nome);
            if (atd != null) {
                remov =BDPizz.getBDPizz().remove(atd);
                encontrado = true;
                if (remov == true){
                    JOptionPane.showMessageDialog(null, "Funcionario Removido.", "Erro", JOptionPane.WARNING_MESSAGE);
                }
            }
        }
        ...
        if (rbEntregador.isSelected()) {
            Entregador entreg = BDPizz.getBDPizz().consultaEntreg(nome);
            if (entreg != null) {
                remov =BDPizz.getBDPizz().remove(entreg);
                encontrado = true;
                if (remov == true){
                    JOptionPane.showMessageDialog(null, "Funcionario Removido.", "Erro", JOptionPane.WARNING_MESSAGE);
                }
        ...
        if (rbCozinheiro.isSelected()) {
            Cozinheiro coz = BDPizz.getBDPizz().consultaCozinheiro(nome);
            if (coz != null) {
                remov =BDPizz.getBDPizz().remove(coz);
                encontrado = true;
                if (remov == true){
                    JOptionPane.showMessageDialog(null, "Funcionario Removido.", "Erro", JOptionPane.WARNING_MESSAGE);
                }
