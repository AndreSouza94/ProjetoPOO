...
public class TablePedido extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnBuscar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buscarPedidosPorCliente(tfBuscaCliente.getText());
            }
        });
    ...
    private void buscarPedidosPorCliente(String nomeCliente) {
        if (!nomeCliente.isEmpty()) {
            List<Pedido> pedidosEncontrados = consultaPedidoPorCliente(nomeCliente);
            ...
            for (Pedido pedido : pedidosEncontrados) {
                ...
                String endereco = pedido.getEndereco() != null ? pedido.getEndereco() : "Não informado";
                String quantidade = String.valueOf(pedido.getQuantidade());
                String tamanho = pedido.getTamanho() != null ? pedido.getTamanho() : "Não especificado";
                String sabor = pedido.getSabor() != null ? pedido.getSabor() : "Não especificado";
